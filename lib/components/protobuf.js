...
var protobuf = require('pomelo2-protobuf');
...
var Component = function (app, opts) {
  ...
  var serverProtos = app.getConfigBasePath(Constants.FILEPATH.SERVER_PROTOS);
  var clientProtos = app.getConfigBasePath(Constants.FILEPATH.CLIENT_PROTOS);

  this.setProtos(Constants.RESERVED.SERVER, serverProtos);
  this.setProtos(Constants.RESERVED.CLIENT, clientProtos);
