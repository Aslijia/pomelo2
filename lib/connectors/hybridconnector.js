...
Connector.prototype.start = function (cb) {
  ...
  var gensocket = function (socket,options) {
    var hybridsocket = new HybridSocket(new ObjectID().toHexString(), socket, options);
  ...
  this.switcher.on('connection', function (socket, options) {
    gensocket(socket,options);
  });
